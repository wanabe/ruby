...
{$(VPATH)}parse.c: $(srcdir)/parse.leg $(srcdir)/tool/ytab.sed {$(VPATH)}id.h peg$(EXEEXT) leg$(EXEEXT)
{$(VPATH)}parse.h: {$(VPATH)}parse.c

{$(VPATH)}parse.c: $(srcdir)/parse.leg leg$(EXEEXT)
	$(ECHO) generating $@
	$(Q) ./leg$(EXEEXT) -o $@ $<
